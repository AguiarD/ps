...
namespace GPS.Controllers
{
    public class JogadorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NameJogador,Mensalista,ObsMensalista,Inativo")] Jogador jogador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NameJogador,Mensalista,ObsMensalista,Inativo")] Jogador jogador)
        {
            if (id != jogador.Id)
            {
                return NotFound();

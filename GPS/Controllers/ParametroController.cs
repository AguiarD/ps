...
namespace GPS.Controllers
{
    public class ParametroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DescParametro,Ponto,Inativo")] Parametro parametro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DescParametro,Ponto,Inativo")] Parametro parametro)
        {
            if (id != parametro.Id)
            {
                return NotFound();
